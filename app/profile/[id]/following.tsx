...
import { fetchFollowing } from '../../../lib/feed';
...
export default function Following() {
  ...
  if (!canView) {
    return (
      <View style={styles.center}>
        <Text style={styles.emptyText}>Ce profil a choisi de ne pas rendre sa liste d'abonnements publique.</Text>
      </View>
    );
  }
  ...
  return (
    <FlatList
      ...
      ListEmptyComponent={
        <View style={styles.center}>
          <Text style={styles.emptyText}>Aucun abonnement pour l'instant.</Text>
        </View>
      }
      renderItem={({ item }) => (
